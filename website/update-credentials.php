...
<div class="navbar">
<img class="MainLogo"src="web-media/Book_Club_tps_1.png"/><!--Image which has transparent background-->
  
</div>
<img class="MainLogo"src="web-media/Book_Club_tps_1.png" /><!--Image which has transparent to make the background not see through-->
   ...
   <div class="wrapper"> 	
    <form method="POST" enctype="multipart/form-data">
       ...
       <div class="input-box">
        ...
        <button type="submit" class="btn" name="submit">Send Password</button>
